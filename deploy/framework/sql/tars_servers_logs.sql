...
replace into `t_adapter_conf` (`application`, `server_name`, `node_name`, `adapter_name`,`registry_timestamp`, `thread_num`, `endpoint`, `max_connections`, `allow_ip`, `servant`, `queuecap`, `queuetimeout`,`posttime`,`lastuser`,`protocol`, `handlegroup`) VALUES ('tars','tarslog','localip.tars.com','tars.tarslog.TopologyObjAdapter',now(),5,'tcp -h localip.tars.com -t 60000 -p 18913',200000,'','tars.tarslog.TopologyObj',200000,60000,now(),NULL,'tars','');
